...
namespace SandcastleBuilder.Package
{
    ...
    public abstract class PackageBase : Microsoft.VisualStudio.Project.ProjectPackage
    {
		...
		#region Handlers for Button: EntityReferencesWindow

		protected virtual void EntityReferencesWindowExecuteHandler(object sender, EventArgs e)
		{
		}
		
		protected virtual void EntityReferencesWindowChangeHandler(object sender, EventArgs e)
		{
		}
		
		protected virtual void EntityReferencesWindowQueryStatusHandler(object sender, EventArgs e)
		{
		}
        ...
        /// this function using the OleMenuCommandService service and the MenuCommand class.
        /// </summary>
        private void ShowToolWindowEntityReferences(object sender, EventArgs e)
        {
            // Get the instance number 0 of this tool window. This window is single instance so this instance
            // is actually the only one.
            // The last flag is set to true so that if the tool window does not exists it will be created.
