...
namespace Microsoft.Isam.Esent.Collections.Generic
{
        ...
        where TKey : IComparable<TKey>
    {
        ...
        /// </param>
        /// <remarks>The column data compression option is enabled when using this constructor</remarks>
        ...
        public PersistentDictionary(string directory, bool compressColumns)
        {
            if (null == directory)
            {
