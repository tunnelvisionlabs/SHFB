...
// and drop from happening at all in a custom project.  Search for "!EFW" to
// find the changes.
// 
//    Date     Who  Comments
// ============================================================================
...
namespace Microsoft.VisualStudio.Project
{
	...
	public partial class ProjectNode : IVsUIHierWinClipboardHelperEvents
	{
		...
		/// Note that this is meant as an helper to the Copy and Paste/Drag and Drop functionality.
		/// </summary>
