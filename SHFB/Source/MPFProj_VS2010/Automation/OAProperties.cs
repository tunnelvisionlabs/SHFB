...
namespace Microsoft.VisualStudio.Project.Automation
{
	...
	public class OAProperties : EnvDTE.Properties
	{
		...
		public virtual EnvDTE.Property Item(object index)
		{
            ...
            // TODO: Check the properties it looks for.  Most can be ignored
            System.Diagnostics.Debug.WriteLine("WARNING: Project queried for unknown property via automation: {0}", index);
            return null;
