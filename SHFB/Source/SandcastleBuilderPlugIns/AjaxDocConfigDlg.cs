    ...
    internal partial class AjaxDocConfigDlg : Form
    {
        ...
        public AjaxDocConfigDlg(string currentConfig)
        {
            ...
            if(node != null)
            {
                ...
                chkRegenerateFiles.Checked = Convert.ToBoolean(node.GetAttribute("regenerate", String.Empty),
            ...
            txtProxyServer.Text = (proxyCreds.ProxyServer == null) ? null : proxyCreds.ProxyServer.OriginalString;
        ...
        {
            txtProxyServer.Enabled = chkUseProxyDefCreds.Enabled = txtProxyUserName.Enabled =
        ...
        private void chkUseProxyDefCreds_CheckedChanged(object sender, EventArgs e)
        {
            if(chkUseProxyDefCreds.Enabled)
                txtProxyUserName.Enabled = txtProxyPassword.Enabled = !chkUseProxyDefCreds.Checked;
        }
