...
namespace SandcastleBuilder.Components.UI
{
    ...
    internal partial class ESentCommentsIndexConfigDlg : Form
    {
        ...
        public ESentCommentsIndexConfigDlg(string currentConfig)
        {
            XElement node;
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            {
                epErrors.SetError(txtFrameworkIndexCachePath, "The Framework comments index cache path " +
                    "is required");
                isValid = false;
            }
            else
            ...
            {
                epErrors.SetError(txtProjectIndexCachePath, "The project comments index cache path is " +
                    "required if enabled");
                isValid = false;
            }
