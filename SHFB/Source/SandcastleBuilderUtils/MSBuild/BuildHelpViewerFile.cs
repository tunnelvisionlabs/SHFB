...
// 1.9.6.0  11/28/2012  EFW  Reduced the number of informational messages generated
//===============================================================================================================
...
namespace SandcastleBuilder.Utils.MSBuild
{
    ...
    public class BuildHelpViewerFile : Task
    {
        ...
        private long addCount, fileCount, folderCount, compressedSize, uncompressedSize;
        #endregion
        ...
        public override bool Execute()
        {
            using(ZipFile zip = new ZipFile())
            {
                ...
                // Compress the entire working folder.  Files are stored relative to the root.
            ...
            switch(e.EventType)
            {
                ...
                case ZipProgressEventType.Saving_Completed:
                    Log.LogMessage(MessageImportance.High, "Finished saving {0}\r\n" +
                        ...
                        e.ArchiveName, folderCount, fileCount, uncompressedSize - compressedSize,
