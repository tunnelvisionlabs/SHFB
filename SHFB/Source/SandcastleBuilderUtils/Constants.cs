...
//
// This code is published under the Microsoft Public License (Ms-PL).  A copy of the license should
// be distributed with the code.  It can also be found at the project website: http://SHFB.CodePlex.com.  This
...
namespace SandcastleBuilder.Utils
{
    ...
    public static class Constants
    {
        ...
        /// </summary>
        public const string ItemTemplates = ProgramDataFolder + "\\" + "Item Templates";

        /// <summary>
        /// This folder is located under the <see cref="Environment.SpecialFolder">LocalApplicationData</see>
        /// folder and contains user-defined conceptual content topic templates that can be added to a project.
        /// </summary>
        public const string ConceptualTemplates = ProgramDataFolder + "\\" + "Conceptual Templates";
        ...
        /// </summary>
        public const string PresentationStylesFolder = ProgramDataFolder + "\\" + "Presentation Styles";
    }
    #endregion
}
