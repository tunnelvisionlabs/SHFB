...
namespace SandcastleBuilder.Utils.BuildEngine
{
    ...
    public enum BuildStep
    {
        ...
        /// <summary>The standard help file content (art, scripts, and styles) is being copied to the help
        ...
        /// <summary>The additional content files are being copied to the help project folder.</summary>
