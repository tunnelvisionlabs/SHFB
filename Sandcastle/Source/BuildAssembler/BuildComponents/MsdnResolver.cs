    ...
    public class MsdnResolver
    {
        ...
        public string GetMsdnUrl(string id)
        {
            if(cachedMsdnUrls.ContainsKey(id))
                return String.Format(CultureInfo.InvariantCulture, urlFormat, locale, cachedMsdnUrls[id]);
            ...
            return String.Format(CultureInfo.InvariantCulture, urlFormat, locale, endpoint);
        }
