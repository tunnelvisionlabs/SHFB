...
namespace Microsoft.Ddue.Tools
{
    ...
    /// </summary>
    public sealed class ScriptSharpDeclarationSyntaxGenerator : SyntaxGeneratorTemplate
    {
        ...
        private static string ReadFullTypeName(XPathNavigator reflection)
        {
            ...
            return String.Format(CultureInfo.CurrentCulture, "{0}.{1}", namespaceName, typeName);
        }
        ...
        public override void WriteAttachedPropertySyntax(XPathNavigator reflection, SyntaxWriter writer)
        {
            ...
            string propertyName = String.Format(CultureInfo.CurrentCulture, "{0}.{1}", typeName,
