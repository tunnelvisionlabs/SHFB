...
"\Program Files (x86)\Windows Installer XML v3.5\bin\heat.exe" dir ..\..\Snippets -out Temp\Snippets.wxs -cg Snippets -gg -sfrag -template fragment -dr INSTALLDIR -var var.RootFolder -indent 2
