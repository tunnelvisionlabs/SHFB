...
// Change history:
// 03/10/2012 - Updated code to fix FxCop warnings.  Reworked to use Collection<T> as the base class to simplify
// the code.  Added code to property support required options.  Added support or '-' option prefix.
