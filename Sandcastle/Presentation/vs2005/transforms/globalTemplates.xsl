        ...
        <table width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <th>
              ...
              <xsl:if test="$codeLangLC='visualbasic' or $codeLangLC='csharp' or $codeLangLC='managedcplusplus' or $codeLangLC='jsharp' or $codeLangLC='jscript' or $codeLangLC='javascript' or $codeLangLC='fsharp' or $codeLangLC='vbscript' or $codeLangLC='xmllang' or $codeLangLC='html' or $codeLangLC='visualbasicandcsharp' or $codeLangLC='xaml'">
